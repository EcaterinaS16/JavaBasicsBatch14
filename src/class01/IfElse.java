...
public class IfElse {
	...
	public static void main(String[] args) {
		 ...
		 * type casting is converting one data type to another data types
		 * why should i learnnn about type casting?
		 * so that we can use the code that is written by someone else too male our life easier
